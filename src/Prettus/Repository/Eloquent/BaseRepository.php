...
namespace JosHoangTien\Repository\Eloquent;
...
use JosHoangTien\Repository\Contracts\PresenterInterface;
use JosHoangTien\Repository\Contracts\RepositoryCriteriaInterface;
use JosHoangTien\Repository\Contracts\RepositoryInterface;
use JosHoangTien\Repository\Events\RepositoryEntityCreated;
use JosHoangTien\Repository\Events\RepositoryEntityCreating;
use JosHoangTien\Repository\Events\RepositoryEntityDeleted;
use JosHoangTien\Repository\Events\RepositoryEntityDeleting;
use JosHoangTien\Repository\Events\RepositoryEntityUpdated;
use JosHoangTien\Repository\Events\RepositoryEntityUpdating;
use JosHoangTien\Repository\Exceptions\RepositoryException;
use JosHoangTien\Repository\Traits\ComparesVersionsTrait;
use JosHoangTien\Validator\Contracts\ValidatorInterface;
use JosHoangTien\Validator\Exceptions\ValidatorException;

/**
 * Class BaseRepository
 *
 * @package JosHoangTien\Repository\Eloquent
...
abstract class BaseRepository implements RepositoryInterface, RepositoryCriteriaInterface
{
    ...
    /**
     * Specify Validator class name of JosHoangTien\Validator\Contracts\ValidatorInterface
     *
     * @return null
     * @throws Exception
     */
    public function validator()
    {
        if (isset($this->rules) && !is_null($this->rules) && is_array($this->rules) && !empty($this->rules)) {
            if (class_exists('JosHoangTien\Validator\LaravelValidator')) {
                $validator = app('JosHoangTien\Validator\LaravelValidator');
                ...
                throw new Exception(trans('repository::packages.JosHoangTien_laravel_validation_required'));
            }
        }
    ...
    public function makePresenter($presenter = null)
    {
        ...
        if (!is_null($presenter)) {
            ...
            if (!$this->presenter instanceof PresenterInterface) {
                throw new RepositoryException("Class {$presenter} must be an instance of JosHoangTien\\Repository\\Contracts\\PresenterInterface");
            }
    ...
    public function makeValidator($validator = null)
    {
        ...
        if (!is_null($validator)) {
            ...
            if (!$this->validator instanceof ValidatorInterface) {
                throw new RepositoryException("Class {$validator} must be an instance of JosHoangTien\\Validator\\Contracts\\ValidatorInterface");
            }
     ...
     *
     * @return $this
     * @throws \JosHoangTien\Repository\Exceptions\RepositoryException
     */
    public function pushCriteria($criteria)
    {
        ...
        if (!$criteria instanceof CriteriaInterface) {
            throw new RepositoryException("Class " . get_class($criteria) . " must be an instance of JosHoangTien\\Repository\\Contracts\\CriteriaInterface");
        }
