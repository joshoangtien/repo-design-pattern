...
Repo Design Pattern is used to abstract the data layer, making our application more flexible to maintain.

[![Latest Stable Version](https://poser.pugx.org/joshoangtien/repo-design-pattern/v/stable)](https://packagist.org/packages/joshoangtien/repo-design-pattern) [![Total Downloads](https://poser.pugx.org/joshoangtien/repo-design-pattern/downloads)](https://packagist.org/packages/joshoangtien/repo-design-pattern) [![Latest Unstable Version](https://poser.pugx.org/joshoangtien/repo-design-pattern/v/unstable)](https://packagist.org/packages/joshoangtien/repo-design-pattern) [![License](https://poser.pugx.org/joshoangtien/repo-design-pattern/license)](https://packagist.org/packages/joshoangtien/repo-design-pattern)
[![Analytics](https://ga-beacon.appspot.com/UA-61050740-1/repo-design-pattern/readme)](https://packagist.org/packages/joshoangtien/repo-design-pattern)
[![Code Climate](https://codeclimate.com/github/andersao/repo-design-pattern/badges/gpa.svg)](https://codeclimate.com/github/andersao/repo-design-pattern)

#### See versions: [1.0.*](https://github.com/andersao/repo-design-pattern/tree/1.0.4) / [2.0.*](https://github.com/andersao/repo-design-pattern/tree/2.0.14)
...
- <a href="#methods">Methods</a>
    - <a href="#joshoangtienrepositorycontractsrepositoryinterface">RepositoryInterface</a>
    - <a href="#joshoangtienrepositorycontractsrepositorycriteriainterface">RepositoryCriteriaInterface</a>
    - <a href="#joshoangtienrepositorycontractscacheableinterface">CacheableInterface</a>
    - <a href="#joshoangtienrepositorycontractspresenterinterface">PresenterInterface</a>
    - <a href="#joshoangtienrepositorycontractscriteriainterface">CriteriaInterface</a>
...
In your `config/app.php` add `JosHoangTien\Repository\Providers\RepositoryServiceProvider::class` to the end of the `providers` array:

```php
'providers' => [
    ...
    JosHoangTien\Repository\Providers\RepositoryServiceProvider::class,
],
```
...
use JosHoangTien\Repository\Contracts\CriteriaInterface;
...
```php
use JosHoangTien\Repository\Eloquent\BaseRepository;
use JosHoangTien\Repository\Criteria\RequestCriteria;
...
class PostRepository extends BaseRepository {
    ...
    public function boot(){
        $this->pushCriteria(app('JosHoangTien\Repository\Criteria\RequestCriteria'));
        ...
    }
...
```php
	public function index()
    {
        $this->repository->pushCriteria(app('JosHoangTien\Repository\Criteria\RequestCriteria'));
        $posts = $this->repository->all();
		...
    }
```
...
`http://joshoangtien.local/users?search=age:17;email:john@gmail.com`
...
```php
use JosHoangTien\Repository\Eloquent\BaseRepository;
use JosHoangTien\Repository\Contracts\CacheableInterface;
use JosHoangTien\Repository\Traits\CacheableRepository;
...
Requires [joshoangtien/laravel-validator](https://github.com/joshoangtien/laravel-validator). `composer require joshoangtien/laravel-validator`

Easy validation with `joshoangtien/laravel-validator`

[For more details click here](https://github.com/joshoangtien/laravel-validator)
...
```php
use \joshoangtien\Validator\LaravelValidator;
...
```php
use \JosHoangTien\Validator\Contracts\ValidatorInterface;
use \JosHoangTien\Validator\LaravelValidator;
...
Validation is now ready. In case of a failure an exception will be given of the type: *joshoangtien\Validator\Exceptions\ValidatorException*
...
```php
use JosHoangTien\Repository\Presenter\FractalPresenter;
...
In your model, implement the interface `JosHoangTien\Repository\Contracts\Presentable` and `JosHoangTien\Repository\Traits\PresentableTrait`

```php
namespace App;

use JosHoangTien\Repository\Contracts\Presentable;
use JosHoangTien\Repository\Traits\PresentableTrait;
...
$repository->setPresenter("JosHoangTien\\Repository\\Presenter\\ModelFractalPresenter");
...
`JosHoangTien\Repository\Presenter\ModelFractalPresenter` is a Presenter default for Models implementing Transformable
...
class PostRepository extends BaseRepository {
    ...
    public function presenter()
    {
        return "JosHoangTien\\Repository\\Presenter\\ModelFractalPresenter";
    }
}
```
